...
<template>
    ...
    <div class="modal fade bg-white bg-opacity-75"
         ...
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-add mx-auto">
    ...
    <div class="modal fade bg-white bg-opacity-75"
        ...
        <div class="modal-dialog modal-dialog-centered modal-add mx-auto">
            <div class="modal-content rounded-0 shadow border-0">
                <div class="modal-header justify-content-center">
                    <h1 class="modal-title font-poppins fw-semibold fs-13" id="modalChangeLabel">
                        O'zgartirish
                    </h1>
                </div>
                <div class="modal-body">
        ...
        <div class="modal-dialog modal-dialog-top modal-delete">
            <div class="modal-content rounded-min shadow border-0">
                <div class="modal-body d-flex align-items-center px-4">
                    <span class="mb-0 font-poppins fw-normal fs-15 text-break">
                        Rost&shy;dan ham o'chi&shy;ril&shy;sin&shy;mi?
                    </span>
